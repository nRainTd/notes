...
大一的时候，我开始尝试用 `next.js` 框架 (这玩意最近 (2025 年) 还爆出一个严重漏洞来着，当时也是学 `react` 的时候被他们的官方文档推过去用的) 手搓博客。又由于我毕竟不是一个生活丰富的人，博客里也没有什么东西可以塞；倒是因为我们网络安全社团的周报制度而积累了不少笔记，所以自然是打算用笔记填充博客。
